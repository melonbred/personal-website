...
export default function GenericButton({ text, href, img }: GenericButtonProps) {
  return (
    <a href={href} target="_blank">
      <div className="bg-green-300 border-4 border-emerald-700 text-green-950 rounded-3xl w-80 h-16 flex items-center m-1 transition duration-150 hover:scale-105">
