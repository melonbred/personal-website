  ...
  return (
    <div className="bg-green-300 border-1 border-emerald-700 rounded-3xl">
      <button onClick={() => setIsClicked(!isClicked)}>
        <div className="bg-green-300 border-2 border-emerald-700 text-green-950 rounded-3xl w-80 h-16 flex items-center m-0 transition duration-150 hover:scale-105">
